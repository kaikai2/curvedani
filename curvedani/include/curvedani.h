...
namespace cAni
{
    ...
    public:
        ...
        virtual void resetToDefault(const iRenderer *renderer) = 0;
    ...
    public:
        ...
        /// @fn getMergeStyleId
        /// @brief return id from name
        virtual MergeStyleId getMergeStyleId(const char *isName) const = 0;

        /// @fn getDefaultMergeStyle
        /// @brief return id from stateid
        virtual MergeStyleId getDefaultMergeStyle(StateId stateId) const = 0;
        
        /// @fn getMergeStyleName
        /// @brief return name from id
        virtual const char *getMergeStyleName(MergeStyleId msId) const = 0;
        ...
        /// @fn render
        /// @brief render the giving clip, or just save them in some rendering buffer and call flush
        virtual void render(const iClipState &rClipState) = 0;

		/// @fn flush
		/// @brief flush rendering stuff, when they need to be processed before actually send to a renderer
		...
		virtual void releaseCurveDataSet(iCurveDataSet *cds) = 0;

        /// @fn render
        /// @brief calc clipstate by merge it with its parent state
        virtual void merge(iClipState &rClipState, const iClipState &rParentClipState) = 0;
    };
    ...
    public:
		...
		virtual int getAnimLength() const = 0;
    ...
    public:
        ...
        iCurveDataSet *createCurveDataSet(const char *rendererName, const char *name);
